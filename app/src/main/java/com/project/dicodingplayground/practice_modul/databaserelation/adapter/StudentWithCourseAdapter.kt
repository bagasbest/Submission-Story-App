package com.project.dicodingplayground.practice_modul.databaserelation.adapter
...
import com.project.dicodingplayground.databinding.ItemStudentBinding
...
class StudentWithCourseAdapter :
    ...
    class WordsComparator : DiffUtil.ItemCallback<StudentWithCourse>() {
        ...
        override fun areContentsTheSame(oldItem: StudentWithCourse, newItem: StudentWithCourse): Boolean {
            return oldItem.studentAndUniversity.university?.name == newItem.studentAndUniversity.university?.name
        }
    }
}