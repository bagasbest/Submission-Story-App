...
import com.project.dicodingplayground.databinding.ActivityViewModelPracticeBinding

class ViewModelPracticeActivity : AppCompatActivity(), View.OnClickListener {
    private var _binding : ActivityViewModelPracticeBinding? = null
    private val binding get() = _binding!!
    private lateinit var mainViewModel: CuboidViewModel
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        _binding = ActivityViewModelPracticeBinding.inflate(layoutInflater)
